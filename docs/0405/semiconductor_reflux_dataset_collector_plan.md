...
- 현재 dataset 파일: [semiconductor-reflux-title-set.json](/home/eorb915/projects/dc_defense_suite/data/semiconductor-reflux-title-set.json)
...
9. 사용자가 `JSON 다운로드` 클릭
10. 내려받은 JSON을 repo의 [semiconductor-reflux-title-set.json](/home/eorb915/projects/dc_defense_suite/data/semiconductor-reflux-title-set.json) 에 반영 후 커밋/배포
...
- [semiconductor-reflux-title-set.json](/home/eorb915/projects/dc_defense_suite/data/semiconductor-reflux-title-set.json)
...
7. 다운로드 파일을 [semiconductor-reflux-title-set.json](/home/eorb915/projects/dc_defense_suite/data/semiconductor-reflux-title-set.json)에 붙여넣고 배포했을 때 loader가 정상 반영하는지
